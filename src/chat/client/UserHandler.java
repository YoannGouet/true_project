...
class UserHandler implements Runnable
{
			...
			Logger parentLogger)
	{
		...
		if (in != null)
		{
			 ...
			 */
			 userInBR = new BufferedReader(new InputStreamReader( in ));//TODO Complete ...
		}
		else
		{
		...
		if (out != null)
		{
			 ...
			 */
			 serverOutPW = new PrintWriter(out,true);//TODO Complete ...
		}
		else
		{
			...
			if (userInput != null)
			{
				 ...
				 */
				 ...
				 if (serverOutPW.checkError()){
					 logger.warning("serverOutPW has error");
					 break;
				 }				 
				 ...
				 */
				 if(userInput.toLowerCase().equals(Vocabulary.byeCmd))break;
			}
			else
			{
